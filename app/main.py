...
@app.post("/users/{user_id}/articles/", response_model=schemas.Article, status_code=status.HTTP_201_CREATED)
...
def update_article(article_id: int, updated_fields: schemas.ArticleUpdate, db: Session = Depends(get_db)):
